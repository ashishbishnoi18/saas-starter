...
config :saas_starter, SaasStarterWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "IznnxVbicJcoleJJKhEAuJXqtF55MU+kPSL9of+kLNpD9gB9mZCRQivKIw7CBQ2k",
  watchers: [
...
config :saas_starter, SaasStarterWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/saas_starter_web/router\.ex$"E,
      ~r"lib/saas_starter_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
